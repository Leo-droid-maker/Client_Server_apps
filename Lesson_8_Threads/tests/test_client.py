...
import sys
sys.path.append("..")
from Lesson_8_Threads.common.config import RESPONSE, ERROR, ACTION, PRESENCE, TIME, USER, ACCOUNT_NAME
from Lesson_8_Threads.client import create_answer, create_presence_message_to_server, start_client
