...
import sys
sys.path.append("..")
from Lesson_10_Descriptors_And_Metaclasses.common.config import RESPONSE, ERROR, ACTION, PRESENCE, TIME, USER, ACCOUNT_NAME
from Lesson_10_Descriptors_And_Metaclasses.client import create_answer, create_presence_message_to_server, start_client
