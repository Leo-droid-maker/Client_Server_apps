import unittest
from Lesson_5_Logging.common.config import RESPONSE, ERROR, ACTION, PRESENCE, TIME, USER, ACCOUNT_NAME
from Lesson_5_Logging.client import create_answer, create_presence_message_to_server, start_client
